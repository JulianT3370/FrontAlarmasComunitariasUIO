...
import * as Location from "expo-location";// api de expo para manejar la localización
...
const AgregarSector = () => {
    ...
    useEffect(() => {
        ...
        if (currentLocation) {
            ...
            (async () => {
                ...
                //Retorna: Un objeto con las coordenadas de latitud y longitud.
    ...
    //Funcion para agregar el sector
